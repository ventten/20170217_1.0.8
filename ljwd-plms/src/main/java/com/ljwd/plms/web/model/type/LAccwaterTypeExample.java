...
/**
 * 账户流水类型查询条件,l_accwater_type
 * */
public class LAccwaterTypeExample extends BaseExample implements Serializable{
    ...
    public LAccwaterTypeExample setIsActive(String isActive) {
