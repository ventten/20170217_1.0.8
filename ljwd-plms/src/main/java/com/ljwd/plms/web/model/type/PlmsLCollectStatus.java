 ...
 * */
public class PlmsLCollectStatus extends ActiveModel  implements Serializable{
    ...
    private String collectCodeGroup;    //催收代码的分组值,用来做二级联动
    ...
    public String getCollectCodeGroup() {
        return collectCodeGroup;
    }

    public void setCollectCodeGroup(String collectCodeGroup) {
        this.collectCodeGroup = collectCodeGroup;
    }
