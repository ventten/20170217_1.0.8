...
/**
 * <p>Java class for chUserListSyncDto complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="chUserListSyncDto">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="list" type="{http://webservice.loan.mfbms.flinkmf.com/}chUserDto" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "chUserListSyncDto", propOrder = {
    "list"
})
public class ChUserListSyncDto {

    @XmlElement(nillable = true)
    protected List<ChUserDto> list;
     ...
     * 
     */
    public List<ChUserDto> getList() {
        if (list == null) {
            list = new ArrayList<ChUserDto>();
        }
        return this.list;
    }
