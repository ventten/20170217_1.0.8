...
<body>
	<div class="caseInfo">
        ...
        <input type="hidden" value="${applDetail.paymentId}" id="paymentId"/>   <!--放款ID-->
                        ...
                        <div class="col-xs-12">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td width="12%" class=" text-center" id="collect-remainingPrincipal">${applDetail.remainingPrincipal}</td>
                                ...
                                <tr>
                                    ...
                                    <td width="12%" class=" text-center" id="collect-overDays">${applDetail.overDays}</td>
                                    ...
                                    <td width="100%" height="60" colspan="10">
                                        <shiro:hasPermission name="collect_rec:info">
                                            <form id="collectCustInfoForm">
                                                ...
                                                <input class="btn btn-primary left-space-2" type="button" id="editorBtn" value="编辑"/>
                                            </form>
                                        </shiro:hasPermission>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="100%" height="30" colspan="10">
                                        <div id="myData">
                                            ...
                                            <shiro:hasPermission name="collect_rec:re_collect">
                                                <input class="btn btn-primary right-space-2" type="button" value="发起再扣" data-toggle="modal" data-target="#recollectModal" onclick="P.resetModal('recollectForm')"/>
                                            </shiro:hasPermission>
                                            ...
                                            <shiro:hasPermission name="collect_rec:keep">
                                                <input class="btn btn-primary right-space-2" type="button" value="保留" data-toggle="modal" data-target="#keepSaveModal" onclick="P.resetModal('keepSaveForm')"/>
                                            </shiro:hasPermission>
                                            <shiro:hasPermission name="collect_rec:transfer">
                                                <input class="btn btn-primary right-space-2" type="button" value="提前移交" data-toggle="modal" data-target="#transferAdvanceModal" onclick="P.resetModal('transferAdvanceForm')"/>
                                            </shiro:hasPermission>
                                            <shiro:hasPermission name="collect_rec:outsrc_keep">
                                                <input class="btn btn-primary right-space-2" type="button" value="委外保留" id="outsrcKeepBtn"/>
                                            </shiro:hasPermission>
                                            <shiro:hasPermission name="case_my:out_add">
                                                <input class="btn btn-primary right-space-2" type="button" value="申请委外" data-toggle="modal" data-target="#outsrcAddModal" onclick="P.resetModal('outsrcAddForm')"/>
                                            </shiro:hasPermission>
                                            <shiro:hasPermission name="case_my:out_visit_add">
                                               <input class="btn btn-primary right-space-2" type="button" value="申请外访" data-toggle="modal" data-target="#outVisitAddModal" onclick="P.resetModal('outVisitSubmitForm')"/>
                                            </shiro:hasPermission>
                                        </div>
                                    </td>
                                </tr>
    ...
    <div style="margin-bottom:15px">
        ...
        <ul class="nav nav-tabs" role="tablist">
            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane active" id="pageCollectionContactor">
                    <jsp:include page="pageCollectionContactor.jsp" flush="true"/>
                </div>
                <div role="tabpanel" class="tab-pane" id="pageCollectionAddress">
                    <jsp:include page="pageCollectionAddress.jsp" flush="true"/>
                </div>
                ...
                <div role="tabpanel" class="tab-pane" id="pageCollectionAnnex">
                    <jsp:include page="pageCollectionAnnex.jsp" flush="true"/>
                </div>
                <div role="tabpanel" class="tab-pane" id="pageCollectionAppl">
                    <jsp:include page="pageCollectionAppl.jsp" flush="true"/>
                </div>
                ...
                <div role="tabpanel" class="tab-pane" id="pageCorresinfo">
                    <jsp:include page="pageCorresinfo.jsp" flush="true"/>
                </div>
                <div role="tabpanel" class="tab-pane" id="pageCollectionOther">
                    <jsp:include page="pageCollectionOther.jsp" flush="true"/>
                </div>
            </div>
        </div>
        <!--选项卡-结束-->
        ...
        <shiro:hasPermission name="collect_rec:insert">
            <jsp:include page="/WEB-INF/views/jsp/case_collection/detail_modal/collectionRecordModal.jsp" flush="true"/>
        </shiro:hasPermission>

        <!--发起保留窗口-->
        <jsp:include page="detail_modal/keepSaveModal.jsp" flush="true"/>
        <!--发起再扣窗口-->
        <jsp:include page="detail_modal/recollectModal.jsp" flush="true"/>
        <!--申请免扣窗口-->
        <jsp:include page="detail_modal/offerExemptModal.jsp" flush="true"/>
        <!--发起提前移交窗口-->
        <jsp:include page="detail_modal/transferAdvanceModal.jsp" flush="true"/>
        <!--发送短信窗口-->
        <jsp:include page="detail_modal/sendSMSModal.jsp" flush="true"/>
        <!--委外申请窗口-->
        <jsp:include page="detail_modal/outsrcAddModal.jsp" flush="true"/>
        <!--外访申请窗口-->
        <jsp:include page="detail_modal/outVisitAddModal.jsp" flush="true"/>
    </div>
</body>
...
<script type="text/javascript" language="javascript">
    ...
    //委外保留按钮
    $(function(){
        $('#outsrcKeepBtn').click(function(){
            MSG.confirm("确定发起委外保留？",function(){
                var applId = $("#applId").val();
                var paymentId = $("#paymentId").val();
                var overduePeriod = $("#overduePeriod").val();
                var overDays = $.trim($("#collect-overDays").text());
                var remainingPrincipal = $.trim($("#collect-remainingPrincipal").text());
                $.ajax({
                    type : 'POST',
                    dataType : "json",
                    url : "<%=request.getContextPath()%>/rest/caseCollection/outsrcKeep",
                    data : {"applId":applId,"paymentId":paymentId,"overduePeriod":overduePeriod,"overdueDays":overDays,"remainingPrincipal":remainingPrincipal},
                    success : function(ret) {
