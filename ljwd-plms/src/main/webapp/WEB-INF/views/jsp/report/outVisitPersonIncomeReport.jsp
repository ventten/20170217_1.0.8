...
<title>外访个人实收明细</title>
</head>
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title">外访个人实收明细</h3>
    </div>
    <div class="panel-body">
        <div>
            <form id="searchForm">
				<input type="hidden" name="type" value="outVisit">
 				<label class="right-space-1">合同编号</label>
                <input class="right-space collection input-border" name="cntrctNo">
                                      
                <label class="right-space-1 label-widthsbig">外&nbsp;&nbsp;访&nbsp;&nbsp;人&nbsp;&nbsp;员</label>
                <select class="right-space collection" name="outVisit" readonly>
                ...
                <shiro:hasPermission name="outVisitPersonIncomeReport:export">
