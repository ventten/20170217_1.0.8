    ...
    var handleSidebarToggler = function() {
        ...
        $('.page-sidebar, .header').on('click', '.sidebar-toggler', function(e) {
            ...
            if (body.hasClass("page-sidebar-closed")) {
            	...
            	if(parseFloat(width)>parseFloat(mainWidth)){
            	...
            	if(parseFloat(windowWidth)>1580){
            		$('#contactor-dataTable-fatherDiv').css('width','101%');
            		$('#record-dataTable-fatherDiv').css('width','101%');
            	}else{
            		$('#contactor-dataTable').css('width','inherit');
            		$('#record-dataTable-one').css('width','inherit');
            	}
                if (body.hasClass('page-sidebar-fixed')) {
                    sidebar.css('width', '');
                }
